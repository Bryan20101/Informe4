  ...
  return (
    <div className="home-container">
      ...
      <div className="publication-card">
        ...
        <div className="publication-info">(Usuario : curso/catedrático : Fecha)</div>
        <p className="publication-text">
          Recomendado 100%, paciente, interesante, etc...
        </p>
        <textarea className="comment-input" placeholder="Comentar..."></textarea>
        <button className="btn-comment">Enviar</button>
      </div>
      ...
      <div className="publication-card">
        ...
        <p className="publication-text">
          Recomendado 100%, paciente, interesante, etc. A mí no me gustó tanto,
          70 de 100 muy estricto.
        </p>
        <textarea className="comment-input" placeholder="Comentar..."></textarea>
        <button className="btn-comment">Enviar</button>
      </div>
