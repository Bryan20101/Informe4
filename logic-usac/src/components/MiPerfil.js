    ...
    <div className="perfil-container">
      ...
      <div className="perfil-content">
        ...
        <div className="perfil-left">
          ...
          <p>Registro académico: <span className="info-link">Mostrar información</span></p>
          <p>Nombre: <span className="info-link">Mostrar información</span></p>
          <p>Apellidos: <span className="info-link">Mostrar información</span></p>
          <p>Contraseña: <span className="info-link">Mostrar información</span></p>
          <p>Correo electrónico: <span className="info-link">Mostrar información</span></p>
          <button className="editar-btn">EDITAR</button>

          <h3>CURSOS APROBADOS <span className="creditos">(CREDITOS) (CR)</span></h3>
          <ul>
            <li>Introduccion a la programacion 1 (5 CR)</li>
            <li>Logica de Sistemas (3 CR)</li>
          </ul>
        </div>
